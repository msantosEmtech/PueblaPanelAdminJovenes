                ...
                <div class="wrap-login100">
                        <div class="login100-form">
                            <div class="card" style="border-radius: 0.75rem;border: none;box-shadow: 0px 4px 4px rgba(0, 0, 0, 0.25);">
                                <div class="card-body">
                                    <h4 class="login100-form-title p-b-59"><b>Recupera tu contraseña</b></h4>
                                    <h6 class="text-center" style="color: #AAAAAA;">Ingresa el código que se te envió por correo</h6>
                                    ...
                                    <div class="text-center">
                                        <p>Solicitar un <a href="<?=base_url('Login/RecuperarContrasenia')?>" style="color: #EC6325;cursor: pointer;"><b>nuevo código</b></a></p>
                                    </div>
                                    <form id="formRecuperarContrasenia" class="form" style="margin: 30px">
                                        <div class="mb-3">
                                            <label class="form-label" for="txtNuevaContrasenia" style="color: #AEB0B3;">Nueva Contraseña</label>
