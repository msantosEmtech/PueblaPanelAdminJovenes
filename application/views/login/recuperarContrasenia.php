                ...
                <div class="wrap-login100">
                        <div class="login100-form">
                            <div class="card" style="border-radius: 0.75rem;border: none;box-shadow: 0px 4px 4px rgba(0, 0, 0, 0.25);">
                                <div class="card-body">
                                    <h4 class="login100-form-title p-b-59"><b>¿Olvidaste tu contraseña?</b></h4>
                                    <h6 class="text-center" style="color: #AAAAAA;">Ingresa tu e-mail y te enviaremos un código para recuperar tu contraseña.</h6>
                                    <form id="formRecuperarContrasenia" class="form" style="margin: 40px">
                                        <div class="mb-3">
                                            <label class="form-label" for="txtCorreo" style="color: #AEB0B3;">Correo Electronico</label>
                                            <input type="email" name="correo" class="form-control" id="txtCorreoRecuperar" required="required">
                                        </div>
                                        <div class="text-center pt-2">
                                            <button type="submit" class="btn  btn-rounded text-uppercase btn-alt-primary text-center btnEntrar" id="btnEnviarCorreoRecuperacion">Enviar</button>
                                        </div>
                                    </form>
                                    <div class="text-center">
                                        <p>Volver a <a href="<?=base_url('Login')?>" style="color: #9A2840;cursor: pointer;">Inicio de sesión</a></p>
                                    </div>
                                </div>
                            </div>
                        </div>
